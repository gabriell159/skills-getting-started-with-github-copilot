...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training sessions and competitive matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["maria@mergington.edu", "nathan@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Art Workshop": {
        ...
        "max_participants": 15,
        "participants": ["emma@mergington.edu", "lily@mergington.edu"]
    },
    "Drama Club": {
